                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Center(child: Text('1', style: GoogleFonts.inter(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600))),
                        ),
                        const SizedBox(width: 20),
                        Text('Shopping cart', style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w600)),
                      ],
                    ),
                    Container(
                      height: 40,
                  ...
                  children: [
                    ListedItems(
                      ...
                      onQuantityChanged: (quantities) {
                        setState(() => itemQuantities = Map<int, int>.from(quantities));
                      },
                      initialQuantities: {
  ...
  Widget _row(String label, double value, {bool big = false}) {
    return Row(
      ...
      children: [
        Text(label,
            style: GoogleFonts.inter(
                fontSize: big ? 16 : 14, fontWeight: FontWeight.w700)),
