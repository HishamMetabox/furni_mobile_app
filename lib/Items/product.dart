...
class ProductWidget extends StatefulWidget {
  const ProductWidget ({super.key, required this.item, required this.onPriceChanged, required this.onQuantityChanged,required this.initialQuantity });
  final CartItem item;
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 20,) ,
                            // to be added
                        Text(widget.item.property, style: GoogleFonts.inter(fontWeight: FontWeight.w400,fontSize: 12, color:Color.fromARGB(255, 102, 110, 114),),),// to be added
                        SizedBox(height: 12,),
                       QuantityCounter(
